    ...
    <div className="container">
      ...
      <div className="row p-5 mt-5 text-center">
        ...
        <img src="media/intradayTrades.svg"/>
            ...
            <p className="text-muted ">Flat ₹ 20 or 0.03% (whichever is lower) per executed order on intraday trades across equity, currency, and commodity trades. Flat ₹20 on all option trades.e</p>
            </div>
        <div className="col-4 p-4">
        <img src="media/pricingEquity.svg"/>
